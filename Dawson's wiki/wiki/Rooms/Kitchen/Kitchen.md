...
Combined Kitchen + dry pantry + service yard, per the Bud Studio "Kitchen/Yard" grouping and
the moodboard's "Kitchen: ... / Service Yard: ..." split.

## Design principles (J&M House Moodboard)
...
- **Dry pantry layout: chose Option 1 over Option 2** — *"Let's go with this"* (see [[04 Decisions]])
- **No dishwasher** — *"We've decided — we won't have a dishwasher!"* (definitive; see [[04 Decisions]])
- **Single combo washer/dryer**, not separate units (see [[04 Decisions]] and [[Washer-Dryer]])
...
- Hacking — $2,800 (incl. in Section B item 1)
- Tiling/waterproofing/plastering — Section D, ~$2,860 of the $12,080 D-total
- 6 carpentry items — Section J items 5–9, ~$8,745
...
> kitchen-specific, and is compiled under [[Whole House]] instead. (This corrects an earlier
> draft placement under Kitchen — see `system/review_queue/2026-06-07-kitchen-and-wholehouse-appliances.md`
...
- `raw/drive/jm-house-moodboard-2026-06-07.md` (slides 16–19)
- `raw/drive/jm-house-moodboard-v2-2026-06-07.md` (slides 11–14)
